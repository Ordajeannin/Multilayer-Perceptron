...
# utils for plotting training history and comparing multiple histories
...
# utils for saving/loading training history
def load_history(path):
    with open(path, "r", encoding="utf-8") as file:
        return json.load(file)

# utils for plotting multiple histories on the same graph for comparison
