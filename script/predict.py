...
# point d'entrée du script de prédiction, qui charge le modèle et le dataset, normalise les données,
# évalue les prédictions du modèle sur le dataset,
# et affiche les métriques d'évaluation ainsi que les premières prédictions
def main():
    if len(sys.argv) != 3:
